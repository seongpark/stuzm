...
<body>
    <form action="process/mogo_new_exam_process.php" method="post">
        <div id="center_card">
            <div id="i_header">
                <div class="back_btn">
                    <a href="../exam">
                ...
                <div class="user_info_div">
                    ...
                    <div class="div">
                        ...
                        <div class="exam_select">
                            <div onclick="exam(0)">
                                <input class="input_hide exam" type="radio" id="3월 모의고사" value="3월 모의고사" name="exam"
                                    required />
                                <label class="exam_type">3월 모의고사</label>
                            </div>
                            <div onclick="exam(1)">
                                <input class="input_hide exam" type="radio" id="6월 모의고사" value="6월 모의고사"
                                    name="exam" />
                                <label class="exam_type">6월 모의고사</label>
                            </div>
                            <div onclick="exam(2)">
                                <input class="input_hide exam" type="radio" id="9월 모의고사" value="9월 모의고사"
                                    name="exam" />
                                <label class="exam_type">9월 모의고사</label>
                            </div>
                        </div>
                    </div>
                </div>
