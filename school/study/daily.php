...
<div class="container">
    ...
    <div class="dropdown">
        <div data-bs-toggle="dropdown" aria-expanded="false">
            <h5 style="font-size:18px;"><?php echo $year; ?>년 <a href="" class="black"><i
    ...
    <div class="scroll-list nav nav-underline mb-4">
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=1">1월</a>
        </div>
        <div class=" nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=2">2월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=3">3월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=4">4월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=5">5월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=6">6월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=7">7월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>>&month=8">8월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=9">9월</a>
        </div>
        <div class="nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=10">10월</a>
        </div>
        <div class=" nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=11">11월</a>
        </div>
        <div class=" nav-item">
            <a class="nav-link black" aria-current="page" href="daily.php?year=<?php echo $year; ?>&month=12">12월</a>
        </div>
    </div>

    <span style=" font-size:15px;"><?php echo $month;?>월의 공부</span>

    <?php  $sql_load_1 = mq("select * from study_log where year='".$year."' and month='".$month."' and userid='{$_SESSION['userid']}'"); 
